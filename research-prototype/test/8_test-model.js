...
/* Not required, embedded into core
describe('V3 HC Schema', () => {
    it('Passes Metaschema validation', function(done) {
        process.env.APP_MODEL_DIR = "../research-app-model";
        appLib.loadModel();
...
describe('V3 HC Research Schema Routes', () => {
    before(function () {
        process.env.MONGODB_URI = process.env.MONGODB_TEST_URI || "mongodb://localhost:27017/research-test";
        process.env.APP_MODEL_DIR = "../research-app-model";
    ...
    it('Generates HC Research core models', function (done) {
