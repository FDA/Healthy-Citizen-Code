(function () {
    ...
    angular
        .module('app.core')
        .factory('hcTemplateEngine', hcTemplateEngine);


    function hcTemplateEngine($rootScope, CONSTANTS) {
        var service = {};
        service.parseTemplate = TemplateGenerator;
            ...
            var components = {
                ...
                'column': function (children, args) {
                    ...
                    return {
                        type: 'div',
                        props: {
                            'class': 'dashboard__grid-column flex-33',
                            'layout': 'column',
                            'layout-wrap': '',
                            'flex': '33',
                            'style': style.join('; ')
