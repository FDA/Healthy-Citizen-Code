...
describe('V3 Backend Datatables Support', () => {
    let sampleDataModel5 = [ // model 5 return is capped to 3 elements
        {"_id": new ObjectID("587179f6ef4807703afd0dfa"), "n": 1, "s": "c", "d": new Date("2017-01-01 00:00:00"), "q": "aaa123"},
        {"_id": new ObjectID("587179f6ef4807703afd0df0"), "n": 3, "s": "a", "d": new Date("2017-01-01 01:00:00"), "q": "aaa12"},
        {"_id": new ObjectID("587179f6ef4807703afd0df7"), "n": 7, "s": "i", "d": new Date("2017-01-01 00:01:00"), "q": "aaa1"},
        {"_id": new ObjectID("587179f6ef4807703afd0df8"), "n": 2, "s": "f", "d": new Date("2019-01-01 00:00:00"), "q": "aaa"},
        {"_id": new ObjectID("587179f6ef4807703afd0df9"), "n": 9, "s": "e", "d": new Date("2018-01-01 00:00:00"), "q": "aaa456"},
        {"_id": new ObjectID("587179f6ef4807703afd0df4"), "n": 4, "s": "j", "d": new Date("2017-05-01 00:00:00"), "q": "456"},
        {"_id": new ObjectID("587179f6ef4807703afd0df6"), "n": 6, "s": "d", "d": new Date("2017-01-01 00:00:02"), "q": "456"},
        {"_id": new ObjectID("587179f6ef4807703afd0df5"), "n": 5, "s": "h", "d": new Date("2017-01-02 00:00:00"), "q": "789"},
        ...
        {"_id": new ObjectID("587179f6ef4807703afd0df1"), "n": 0, "s": "b", "d": new Date("2017-04-01 00:00:00"),
            "as": [
                { "_id": new ObjectID("487179f6ef4807703afd0df1"), "n": 1, "s": "c", "d": new Date("2017-01-01 00:00:00"), "q": "aaa123" },
                { "_id": new ObjectID("487179f6ef4807703afd0df0"), "n": 3, "s": "a", "d": new Date("2017-01-01 01:00:00"), "q": "aaa12" },
                { "_id": new ObjectID("487179f6ef4807703afd0df7"), "n": 7, "s": "i", "d": new Date("2017-01-01 00:01:00"), "q": "aaa1" },
                { "_id": new ObjectID("487179f6ef4807703afd0df8"), "n": 2, "s": "f", "d": new Date("2019-01-01 00:00:00"), "q": "aaa" },
                { "_id": new ObjectID("487179f6ef4807703afd0df9"), "n": 9, "s": "e", "d": new Date("2018-01-01 00:00:00"), "q": "aaa456" },
                { "_id": new ObjectID("487179f6ef4807703afd0df4"), "n": 4, "s": "j", "d": new Date("2017-05-01 00:00:00"), "q": "456" },
                { "_id": new ObjectID("487179f6ef4807703afd0df6"), "n": 6, "s": "d", "d": new Date("2017-01-01 00:00:02"), "q": "789" },
                { "_id": new ObjectID("487179f6ef4807703afd0df5"), "n": 5, "s": "h", "d": new Date("2017-01-02 00:00:00"), "q": "789" },
                { "_id": new ObjectID("487179f6ef4807703afd0df2"), "n": 8, "s": "a", "d": new Date("2017-01-03 00:00:00"), "q": "" },
                { "_id": new ObjectID("487179f6ef4807703afd0df3"), "n": 1, "s": "g", "d": new Date("2017-01-01 00:00:01") }
            ]
        }
    ];
    beforeEach(function (done) {
        global.columnsDatatablesSpec = _.map( ['_id','n','s','d','q'], (name,idx) => `columns[${idx}][data]=${name}&columns[${idx}][name]=${name}&columns[${idx}][searchable]=true&columns[${idx}][orderable]=true&columns[${idx}][search]=&columns[${idx}][search][regex]=false` ).join("&");
        async.series([
            (cb) => appLib.db.connection.collection('model5s').remove({}, cb),
            (cb) => appLib.db.connection.collection('model5s').insert(sampleDataModel5, cb)
        ], done)
    });
    describe('1st level', function () {
        ...
        it('returns correct 1st level data with all datatables parameters and search in searchable field for angular datatables directive', function (done) {
            request(app)
                ...
                .set('Accept', 'application/json')
                .expect('Content-Type', /json/)
                .end(function (err, res) {res.body.success.should.equal(true, res.body.message);
                    res.statusCode.should.equal(200, JSON.stringify(res, null, 4));
                    res.body.data.length.should.equal(2);
