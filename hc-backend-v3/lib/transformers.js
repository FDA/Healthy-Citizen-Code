        ...
        if (path.length == 0) { // time to call handler
            ...
            if ('transform' == type) {
                if (global.appModelHelpers.Transformers[handler]) {
                    ...
                    //} catch(e) {
                    //    let error = `Exception while running transformer ${handler}: ${e}`;
                    //    log.error(error);
                    //    cb(error);
                    //}
                } else {
                ...
                if (global.appModelHelpers.Validators[handler.validator]) {
                    ...
                    //} catch(e) {
                    //    let error = `Exception while running validator ${handler.validator}: ${e}`;
                    //    log.error(error);
                    //    cb(error);
                    //}
                } else {
                ...
                //} else {
                //    cb(`Incorrect validator spec ${JSON.stringify(handler)} at ${lodashPath}`);
                //}
            } else {
