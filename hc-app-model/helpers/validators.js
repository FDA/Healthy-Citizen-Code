...
module.exports = function (vutil) {
    ...
    var m = {
        "dischargeDispositionAndStatusExpired": function (modelName, lodashPath, appModelPart, handlerSpec, cb) {
        ...
        "notBeforeEncounterAdmissionDate": function (modelName, lodashPath, appModelPart, handlerSpec, cb) {
        ...
        "notAfterEncounterDischargeDate": function (modelName, lodashPath, appModelPart, handlerSpec, cb) {
            var val = vutil.getValue(this, appModelPart, lodashPath);
            var encounterPath = lodashPath.split('.').slice(0, 2).join('.') + '.';
        ...
        "homeLabsTestResultUnit": function (modelName, lodashPath, appModelPart, handlerSpec, cb) {
            var unitsMapping = {
                "1": "16",
                "2": "21",
                "3": "39",
