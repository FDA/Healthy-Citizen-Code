...
angular.module('SmartAdmin.Layout').directive('smartLayout', function (
  ...
  HcLayoutConfigService
    ...
    (function applyConfigSkin(){
      ...
      $body.addClass(HcLayoutConfigService.getSkin());
    })();

  (function defineLayoutParams() {
    var classes = HcLayoutConfigService.layoutClass();
    var bg = HcLayoutConfigService.get('background');
