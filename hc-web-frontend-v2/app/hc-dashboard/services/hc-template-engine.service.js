;(function() {
  ...
  angular
    ...
    .factory('hcTemplateEngineService', hcTemplateEngineService);
  
  
  function hcTemplateEngineService($rootScope, CONSTANTS) {
      ...
      var components = {
        ...
        'tile': function (children) {
          return {
            type: 'div',
            props: {
              'class': 'hc-dashboard__item'
            },
            children: {
              type: 'div',
              props: {
                'class': 'hc-dashboard__tile panel panel-default'
              },
              children: children
            }
          };
        ...
        'tile-x2': function (children) {
          return {
            type: 'div',
            props: {
              'class': 'hc-dashboard__item hc-dashboard__item-x2'
            },
            children: {
              type: 'div',
              props: {
        ...
        'tile-x3': function (children) {
          return {
            type: 'div',
            props: {
              'class': 'hc-dashboard__item hc-dashboard__item-x3'
            },
            children: {
              type: 'div',
              props: {
        ...
        'tile-x4': function (children) {
          return {
            type: 'div',
            props: {
              'class': 'hc-dashboard__item hc-dashboard__item-x4'
            },
            children: {
              type: 'div',
              props: {
