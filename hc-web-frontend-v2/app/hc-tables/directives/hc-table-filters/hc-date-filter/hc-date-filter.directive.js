;(function () {
  ...
  angular
    .module('app.hcTables')
    .directive('hcDateFilter', hcDateFilter);

  function hcDateFilter (BS_DATE_FORMAT) {
    return {
      restrict: 'E',
      replace: true,
      scope: {
      ...
      templateUrl: 'app/hc-tables/directives/hc-table-filters/hc-date-filter/hc-date-filter.html',
