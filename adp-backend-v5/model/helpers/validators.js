...
module.exports = function (appLib) {
  ...
  const m = {
    ...
    "notInFuture": function (modelName, lodashPath, appModelPart, userContext, handlerSpec, cb) { // TODO: replace with max(date) and $now/@now?
      var val = vutil.getValue(this, appModelPart, lodashPath);
    ...
    "imperialHeightRange": function (modelName, lodashPath, appModelPart, userContext, handlerSpec, cb) {
