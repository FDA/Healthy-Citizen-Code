...
module.exports = function (mongoose) {
    ...
    const m = {
        "trim": function (path, appModelPart, userContext, next) {
        ...
        "heightImperialToMetric": function (path, appModelPart, userContext, next) {
            let val = _.get(this, path);
        ...
        "heightMetricToImperial": function (path, appModelPart, userContext, next) {
            let val = _.get(this, path);
            if (val) {
        ...
        "weightImperialWithOzToMetric": function (path, appModelPart, userContext, next) {
            let val = _.get(this, path);
            if (val && Array.isArray(val) && val.length > 1) {
        ...
        "weightMetricToImperialWithOz": function (path, appModelPart, userContext, next) {
            let val = _.get(this, path);
            if (val) {
        ...
        "weightImperialToMetric": function (path, appModelPart, userContext, next) {
            let val = _.get(this, path);
            if (val) {
        ...
        "weightMetricToImperial": function (path, appModelPart, userContext, next) {
            let val = _.get(this, path);
            if (val) {
        ...
        "addLookupDetails": function (path, appModelPart, userContext, next) {
