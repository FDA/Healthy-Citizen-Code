...
describe('Macroses', () => {
  ...
  it(`should insert strings from file and inline macroses`, async function() {
    const { appLib } = this;
  ...
  it(`should insert strings from recursive macroses`, async function() {
    const { appLib } = this;
  ...
  it(`should fail for infinite recursive macroses`, async function() {
    const { appLib } = this;
  ...
  it(`should fail for invalid macros name`, async function() {
    ...
    await this.appLib.setup().should.be.rejectedWith(/Unknown macros invalidMacroName/);
  });

  it(`should fail for invalid json after macroses work`, async function() {
    const { appLib } = this;
