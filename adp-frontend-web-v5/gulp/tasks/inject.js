...
gulpInject.transform.html.js = function (_path) {
  return `<script type="application/javascript" src="/${_path}"></script>`;
};

const conf = require('../config');

function polyfillsStream() {
  return gulp.src([path.join(conf.paths.tmp, conf.paths.polyfillsScripts)], {
    read: false,
  });
}
...
function injectNpmJs() {
  return gulp
    .src(getMainBowerFiles(), { read: false })
    .pipe(gulpFilter(['**/*.js']))
    .pipe(
      gulpOrder([
        '**/jquery.js',
...
function injectNpmCSS() {
  return gulp.src(getMainBowerFiles(), { read: false }).pipe(gulpFilter(['**/*.css']));
}
...
function getMainBowerFiles() {
  return mainBowerFiles({
    ...
    overrides: {
      ...
      devextreme: {
        main: ['./dist/js/dx.all.js', './dist/css/dx.common.css', './dist/css/dx.material.blue.light.compact.css'],
        dependencies: {
          jszip: '^3.0.0',
          exceljs: '^3.4.0',
        },
      ...
      'wavesurfer.js': {
        main: ['./dist/wavesurfer.js', './dist/plugin/wavesurfer.microphone.min.js'],
        dependencies: {},
      },
      'videojs-wavesurfer': {
      ...
      'ui-cropper': {
        main: ['compile/unminified/ui-cropper.js', 'compile/unminified/ui-cropper.css'],
      },
      'jquery-migrate': {
      ...
      echarts: {
        main: ['./dist/echarts-en.common.min.js', './dist/echarts.common.min.js'],
      },
      'js-yaml': {
      ...
      simplebar: {
        main: ['./dist/simplebar.min.css', './dist/simplebar.min.js'],
      },
      'can-use-dom': {
        ignore: true,
      },
