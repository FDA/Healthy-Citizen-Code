;(function () {
  ...
  function AdpFormDataUtils(
    ...
    function _cleanObject(formData, currentField, path, options) {
      ...
      if (_.isEmpty(objectValue)) {
        if (options.clearEmptyOnly) {
          parentFormData[currentField.fieldName] = currentField.required && isRoot ? {} : null
        } else {
          parentFormData[currentField.fieldName] = null;
        }
      }
    }
    ...
    function _cleanArray(currentField, arrayFormData, parentFormData, options) {
      if (options.clearEmptyOnly) {
        ...
        if (_.isEmpty(arrayFormData)) {
          parentFormData[currentField.fieldName] = currentField.required ? [{}] : null;
        }
      } else {
    ...
    function _cleanTreeSelector(formData, currentField, path) {
      ...
      var fName = currentField.fieldName;
