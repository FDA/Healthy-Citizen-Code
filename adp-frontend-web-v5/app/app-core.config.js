...
appConfig.skins = [
    {name: "smart-style-0",
        logo: "http://via.placeholder.com/140x35",
...
if (appConfig.voice_command) {
        ...
        'mute' : function() {
            ...
            toastr.success("All sounds have been muted!", "MUTE");
        },
        'sound on' : function() {
            appConfig.sound_on = true;
            $.speechApp.playConfirmation();
            toastr.success("All sounds have been turned on!","UNMUTE");
        },
        'stop' : function() {
        ...
        'help' : function() {
            ...
            $('#voiceModal').removeData('modal').modal( { remote: "app/adp-layout/partials/voice-commands.tpl.html", show: true } );
            if ($('#speech-btn .popover').is(':visible')) {
                $('#speech-btn .popover').fadeOut(250);
            }
