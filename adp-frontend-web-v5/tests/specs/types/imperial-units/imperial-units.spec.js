  ...
  describe('Imperial Units types: actions', () => {
    ...
    test(
      ...
      async () => {
        ...
        await selectOptionByValueForName(valueToSelect, FIELD_NAMES.IMPERIAL_WEIGHT, this.page);
        const actualSelectedValue = await getSingleSelectValueByName(FIELD_NAMES.IMPERIAL_WEIGHT, this.page);
