...
class Menu extends Component {
    ...
    render() {
        const {currentRoute, currentPath, closeMenu, profile, reset} = this.props;
            ...
            >
                ...
                >
                    <Text
                        style={styles.name}
                    >
                        {profile && profile.firstName && profile.lastName ? `${profile.firstName} ${profile.lastName}` : 'Healthy Citizen'}
                    </Text>
                </View>
